...
export default function HospitalDetails({ data }: HospitalDetailsProps) {
  const [showMore, setShowMore] = useState(false);
  const [update, setUpdate] = useState('');
  const hospText = useRef<HTMLDivElement>(null);
  ...
  function handleShowMore(backNormal = false) {
    if (backNormal) {
      ...
      document.getElementById('hospital_text')!.style.backgroundColor = 'azure';
    } else {
