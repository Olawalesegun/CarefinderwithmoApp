...
export default function SucessModal({ setShowModal, formDetails }: { setShowModal: (value: boolean) => void; formDetails: FormDetails }) {
  
  function handleDocument() {

    const doc = new jsPDF();

    const formData = document.getElementById('formData') as HTMLElement; // Type casting
    ...
    setTimeout(() => {
      ...
      html2canvas(formData).then((canvas) => {
        ...
        doc.addImage(imgData, "PNG", 10, 10, 180,  
 180);
